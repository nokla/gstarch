...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ route('arc.index', ['id'=>$serv->division ]) }}">{{ GetDiv($serv->division) }}</a></li>
      <li class="breadcrumb-item active" aria-current="page">{{ $serv->code }}</li>
    </ol>
  </nav>
@endsection
                ...
                <div class="col-auto">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{ route('doc.NewDoc', ['arc'=>$serv->iArch]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
                            <path d="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z"/>
                            <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"/>
                          </svg>&nbsp; Un Nouveau Document</a></li>

                          <li><a class="dropdown-item" href="{{ route('doc.multi', ['id'=>$serv->iArch]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">
                    ...
                    <a class="btn app-btn-secondary" id="newfld" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">
                      ...
                      <a class="btn app-btn-secondary" id="zipit" href="{{ route('arc.zip', ['id'=>$serv->iArch]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-zip-fill" viewBox="0 0 16 16">
                    ...
                    <table class="table app-table-hover mb-0 text-left" id="lstdocs">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('arc.folder', ['id'=>$item->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
            ...
            <div id="res">
                <form method="POST" action="/submit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="src" id="src" value="{{ $serv->iArch }}">
                        <input type="hidden" name="nav" id="nav" value="2">
                        <input type="hidden" name="tt" id="tt" value="s">
                        <input type="hidden" name="dd" id="dd" value="{{ $serv->id }}">
                        <input type="hidden" name="stk" id="stk" value="{{ hash('sha256', $serv->code)  }}">
                    </div>
                </form>
            </div>
