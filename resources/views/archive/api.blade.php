...
<div class="app-card alert alert-success text-white alert-dismissible shadow-sm mb-4 border-left-decoration bg-white" role="alert">
 ...
 @endif
<form id="fileUploadForm" method="POST" action="{{ route('cri.gprojet') }}" enctype="multipart/form-data">
    @csrf
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="app-card app-card-settings shadow-sm p-4 h-100">
                ...
                <div class="app-card-body h-100 p-2 m-2">
                    <div class="mb-3">
                        <label for="projet" class="form-label">Objet:</label>
                        <input type="text" class="form-control" id="projet"  name="projet" placeholder="projet" required="">
                    </div>
                    <div class="mb-3">
                        <label for="num" class="form-label">Référence :</label>
